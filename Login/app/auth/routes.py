...
from Login.app.auth.forms import RegistrationForm, LoginForm, ScrapyForm 
...
def scrapy_data(): 
    ...
    if form.validate_on_submit(): 
        ...
        if len(data_articles) == 0: 
            data = {"links": ["No se encontró información para la consulta realizada"]} 
        else: data = {"links": data_articles} 
